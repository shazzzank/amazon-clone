...
const UpdateProfile = ()=>{
	...
	const [avatarPreview, setAvatarPreview] = useState('https://my-unique-ecommerce-v2.s3.eu-north-1.amazonaws.com/1693044788591.webp');
	...
	return(
		<div className="container container-fluid">
			<Toast ref={toastRef} redirect="/me"/>
